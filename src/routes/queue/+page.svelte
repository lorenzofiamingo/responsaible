...
<section class="head">
	...
	<p class="sub">
		Every AI-generated work product across all matters, ordered by priority and lowest confidence
		first — so the items most needing a human are at the top.
	</p>
</section>
...
<div class="toolbar">
	...
	<div class="filters">
		...
		<select bind:value={statusFilter} class:on={statusFilter !== 'all'} aria-label="Filter by status">
		...
		<select bind:value={confFilter} class:on={confFilter !== 'all'} aria-label="Filter by confidence">
